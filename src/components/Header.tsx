    ...
    <header className={`fixed w-full top-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center space-x-3 group">
            <div className="relative">
              ...
              <div className="relative gradient-primary p-3 rounded-2xl">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-display text-sm font-medium gradient-text tracking-wider">
                STUDIO
              </span>
            </div>
            <div className="hidden sm:flex items-center ml-4 glass px-3 py-1 rounded-full">
        ...
        <div className={`lg:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="aqua-glass-dark rounded-2xl m-4 p-6 space-y-4 edge-glow">
            {[
              { key: 'services', label: t('header.services') },
              { key: 'testimonials', label: t('header.success') },
              { key: 'pricing', label: t('header.pricing') },
