      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto items-stretch">
          {currentPlans.map((plan, index) => (
            ...
            >
              <div className={`aqua-glass-dark rounded-3xl p-6 sm:p-8 h-full lg:min-h-[720px] hover:scale-105 transition-all duration-500 relative overflow-hidden flex flex-col ${
